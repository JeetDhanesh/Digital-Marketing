@extends('front.layout.app', ['title' => 'Home'])
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-agency-list">
                        ...
                        <div class="about-agency-item wow fadeInUp">
                            <div class="icon-box">
                                <img src="{{asset('assets/front/images/icon-about-agency-1.svg')}}" alt="">
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="agency-social-item wow fadeInUp">
                        ...
                        <div class="agency-social-btn">
                            <a href="contact.html" class="readmore-btn"><img src="{{asset('assets/front/images/arrow-white.svg')}}" alt=""></a>
                        </div>
                    ...
                    <div class="work-process-item wow fadeInUp">
                        ...
                        <div class="work-process-body">
                            ...
                            <div class="work-process-icon-box">
                                <img src="{{asset('assets/front/images/icon-work-process-1.svg')}}" alt="">
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="work-process-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="work-process-body">
                            ...
                            <!-- Work Process Icon Box Start -->
                            <div class="work-process-icon-box">
                                <img src="{{asset('assets/front/images/icon-work-process-2.svg')}}" alt="">
                            </div>
                            <!-- Work Process Icon Box End -->
                        </div>
                        <!-- Work Process Body End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="work-process-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="work-process-body">
                            ...
                            <!-- Work Process Icon Box Start -->
                            <div class="work-process-icon-box">
                                <img src="{{asset('assets/front/images/icon-work-process-3.svg')}}" alt="">
                            </div>
                            <!-- Work Process Icon Box End -->
                        </div>
                        <!-- Work Process Body End -->
					...
					<div class="row project-item-boxes align-items-center">
						<div class="col-lg-4 col-md-6 project-item-box branding web analytics">
                            ...
                            <div class="project-item wow fadeInUp">
                                <div class="project-image">
                                    <figure class="image-anime">
                                        <img src="{{asset('assets/front/images/project-1.jpg')}}" alt="">
                                    </figure>
                                    ...
                                    <div class="project-btn">
                                        <a href="project-single.html"><img src="{{asset('assets/front/images/arrow-white.svg')}}" alt=""></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 project-item-box web digital urban">
                            ...
                            <div class="project-item wow fadeInUp">
                                <div class="project-image">
                                    <figure class="image-anime">
                                        <img src="{{asset('assets/front/images/project-2.jpg')}}" alt="">
                                    </figure>
                        ...
                        <div class="col-lg-4 col-md-6 project-item-box digital analytics">
                            ...
                            <div class="project-item wow fadeInUp" data-wow-delay="0.2s">
                                <div class="project-image">
                                    <figure class="image-anime">
                                        <img src="{{asset('assets/front/images/project-3.jpg')}}" alt="">
                                    </figure>
                        ...
                        <div class="col-lg-4 col-md-6 project-item-box branding analytics">
                            ...
                            <div class="project-item wow fadeInUp" data-wow-delay="0.4s">
                                <div class="project-image">
                                    <figure class="image-anime">
                                        <img src="{{asset('assets/front/images/project-4.jpg')}}" alt="">
                                    </figure>
                        ...
                        <div class="col-lg-4 col-md-6 project-item-box web service branding">
                            ...
                            <div class="project-item wow fadeInUp" data-wow-delay="0.6s">
                                <div class="project-image">
                                    <figure class="image-anime">
                                        <img src="{{asset('assets/front/images/project-5.jpg')}}" alt="">
                                    </figure>
                        ...
                        <div class="col-lg-4 col-md-6 project-item-box digital">
                            ...
                            <div class="project-item wow fadeInUp" data-wow-delay="0.8s">
                                <div class="project-image">
                                    <figure class="image-anime">
                                        <img src="{{asset('assets/front/images/project-6.jpg')}}" alt="">
                                    </figure>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="benefits-steps-item wow fadeInUp">
                        ...
                        <div class="icon-box">
                            <img src="{{asset('assets/front/images/icon-benefits-steps-1.svg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="benefits-steps-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="icon-box">
                            <img src="{{asset('assets/front/images/icon-benefits-steps-2.svg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="benefits-steps-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="icon-box">
                            <img src="{{asset('assets/front/images/icon-benefits-steps-4.svg')}}" alt="">
                        </div>
